          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para uma chamada de voz, vamos conversar e descobrir a melhor forma de resolução para seu problema
                  juntos?
                </Text>
                <Text
                  as="a"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Me mande um email reportando feedbacks, sugestões e idéias
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Vamos criar interações mais constantes e trabalhar em nosso network
                </Text>
                <Text
                  as="a"
                  color="grey2"
